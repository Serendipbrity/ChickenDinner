...
const ADD_STORE = gql`
  mutation addStore($routeOrder: Number, $storeName: String, $storeAddress: String, $region: String, $contactName: String, $contactInfo: String, $whenCanContact: String, $directions: String) {
    addStore(routeOrder: $routeOrder, storeName: $storeName, storeAddress: $storeAddress, region: $region, contactName: $contactName, contactInfo: $contactInfo, whenCanContact: $whenCanContact, directions: $directions) {
        id
        routeOrder
        storeName
        storeAddress
